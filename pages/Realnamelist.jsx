...
class MainCont extends Component {
    ...
    upData = (callback) => { //更新表单数据
        ...
        fetch('/member/realname_list.do?' + tools.parseParam(postData), {
            method: "get",
    ...
    openLogs = (id) => {
        this.openContId = id;
        this.toggleModal(0)
        //  + tools.parseParam({ content_id: id })
                    ...
                    <tbody>
                        {(() => {
                            ...
                            // return logList.map(function (obj, idx) {
                                return (<tr >
                                    <td>{logList.id}</td>
                                    <td>{logList.content_id}</td>
                                    <td>
                                        {logList.username}
                                    </td>
                                    <td>{logList.add_time}</td>
            ...
            return (<tr key={idx}>
                ...
                <td>
                    ...
                    <div className="btn-group mb15">
                        <a href={"#/member/detail/" + obj.id} className="btn btn-sm btn-info">查看详情</a>
