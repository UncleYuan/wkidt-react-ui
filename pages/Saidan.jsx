...
class MainCont extends Component {
    ...
    setEidtForm = (data) => { //保存表单
        ...
        let url = "";
        data.l_id = this.props.params.id;
        data.uid = this.props.params.vip_id;
        if (this.formType == "add") {

            url = "oneyuan/goods/saidan.do";
        ...
        for (let i in data.img) {
            newThumb.push(data.img[i].src);
        }
        data.img = newThumb.join(',');
        Process.show();
                        ...
                        conf: {
                            footer: (
                                <div>
                                    ...
                                    <a href="javascript:;" onClick={() => { location.hash = "/oneyuan/order.html"; Modal.close(); } } className="btn btn-info">回到列表</a>
                                </div>
                            )
                        }
                    })
