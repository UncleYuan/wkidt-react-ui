...
class AdsCont extends Component {
  ...
  upData = (callback) => { //更新表单数据
    ...
    fetch('/ads/ads_first.do?' + tools.parseParam(postData), {
      method: "get",
  ...
  sureDelItem = (id) => {
    ...
    fetch('/ads/ads_first_delete.do?'+tools.parseParam({id: id.join(',')}), {
      method: "get",
      credentials: 'same-origin',
      headers: {
  ...
  render() {
    ...
    let cont = rendData.map(function (obj, idx) {
      return (<tr key={idx}>
        ...
        <td>{obj.id}</td>
        <td><a href={"#/ads/adsfirstEdit/details/edit/" + obj.id} className="">{obj.title}</a></td>
        <td>{obj.time}</td>
        ...
        <td>
          ...
          <div className="btn-group mb15">
           <a href={"#/ads/adsfirstEdit/details/edit/" + obj.id} className="btn btn-sm btn-info">更新广告</a>
            ...
            <div className="panel-body">
              <div className="row">
                <div className=" col-md-9">
                  <div className="btn-group mb15">
                     <a href="#/ads/adsfirstEdit/details"  className="btn btn-info">添加广告</a>
