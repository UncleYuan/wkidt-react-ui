...
class AdsCont extends Component {
  ...
  upData = (callback) => { //更新表单数据
    ...
    if (this.state.auditType == 'none') {
      ...
      postData = { name: searchTxt, page: page.page_index, len, status: this.state.auditType == 0 ? '0' : '2' }
    }
    fetch('/ads/ads_audit_list.do?' + tools.parseParam(postData), {
      method: "get",
          ...
          <section className="panel">
            ...
            <div className="panel-body">
              ...
              <div id="column-table">
                ...
                <Modal title="审核广告" sizeClass="sm" maxWidth="1000" show={modalShow[1]} onClose={() => { this.toggleModal(1) } }>
