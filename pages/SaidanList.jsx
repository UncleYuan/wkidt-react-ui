...
class MainCont extends Component {
  ...
  upData = (callback) => { //更新表单数据
    ...
    fetch(`oneyuan/goods/saidan/${this.props.params.id}.do`, {
      method: "get",
  ...
  render() {
    ...
    let cont = rendData.map(function (obj, idx) {
      return (<tr key={idx}>
        ...
        <td>
          {
            obj.img.map((data,idx)=>{
              return (
               <a href="javascript:;"><img onClick={this.handlePic.bind(this,data)} key={idx} className="w40 h40 br_100 mr10 vm" src={data || "/admin/images/head.png"} alt="" /></a> 
              )
            })
          }
      ...
      <div>
        ...
        <div className="wrapper">
          <section className="panel">
            <Modal show={modalShow[2]} onClose={this.toggleModal.bind(this,2,false)}>
              <div className="tc"><img src={this.state.src} alt=""/></div>
            </Modal>
