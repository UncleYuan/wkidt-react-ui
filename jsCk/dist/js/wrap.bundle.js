...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sider = __webpack_require__(219);
	...
	var typeTree = function typeTree(result, re_id) {
	...
	var Wrap = function (_Component) {
	  ...
	  function Wrap(props) {
	    ...
	    _this.getMenu = function () {
	      ...
	      var data = {
	        "0": {
	          ...
	          "remark": "",
	          "listorder": "0",
	          "url": "jindian/jindian_auditelist.html"
	        },
	        "1": {
	          "id": "186",
	          "name": "番禺龙胜极速车行",
	      ...
	      var arr1 = [{ name: "总部", icon: "home", url: "#", children: [] }];
	      var newArr = arr1.concat(typeTree(data, 0));
	    ...
	    _this.getUserInfo = function () {
	      ...
	      var userInfo = {
	        avatar: "http://7xp4uq.com1.z0.glb.clouddn.com/2016-07-09_5780619b7f103.jpg",
	        email: "735041553@qq.com",
	        token: "ts9d0brb1kgddfi8bpnpbunm45",
	        user_id: "1",
	        username: "sysadmin"
	      };
	      _this.setState({ userInfo: userInfo, loading: false });
	    };
	
	    _this.toggleSider = function () {
	      var closeSider = _this.state.closeSider;
	
	      _this.setState({ closeSider: !closeSider });
	    };
	  ...
	  _createClass(Wrap, [{
	    ...
	    value: function render() {
	      ...
	      var pageProps = { key: pathname };
	      if (pathname.indexOf('zc.html') >= 0) {
	        pageProps.type = this.props.params.type ? this.props.params.type : 'index';
	      }
	      return _react2["default"].createElement(
	        'div',
	        { className: "content-all-wrap " + (closeSider ? "close-sider" : "") },
	        _react2["default"].createElement(_Sider2["default"], { menuData: menuData }),
	        _react2["default"].createElement(_AppBar2["default"], { onClickToggle: this.toggleSider }),
	        _react2["default"].createElement(
	          'div',
	          { className: 'main-wrap ' },
	          _react2["default"].cloneElement(this.props.children || _react2["default"].createElement('div', null), pageProps)
	        )
	      );
	    }
	  }]);
	  ...
	  },*/
	  {
	    ...
	    getComponent: function getComponent(nextState, cb) {
	      __webpack_require__.e/* nsure */(2, function (require) {
	        cb(null, __webpack_require__(223)["default"]);
	      });
	    }
	  }, {
	    path: '/cp.html',
	    ...
	    getComponent: function getComponent(nextState, cb) {
	      __webpack_require__.e/* nsure */(15, function (require) {
	        cb(null, __webpack_require__(254)["default"]);
	      });
	    }
	  }, {
	    path: '/cplist.html',
	    ...
	    getComponent: function getComponent(nextState, cb) {
	      __webpack_require__.e/* nsure */(18, function (require) {
	        cb(null, __webpack_require__(257)["default"]);
	      });
	    }
	  }, {
	    path: '/dd.html',
	    ...
	    getComponent: function getComponent(nextState, cb) {
	      __webpack_require__.e/* nsure */(20, function (require) {
	        cb(null, __webpack_require__(259)["default"]);
	      });
	    }
	  }, {
	    path: '/yclist.html',
	    ...
	    getComponent: function getComponent(nextState, cb) {
	      __webpack_require__.e/* nsure */(22, function (require) {
	        cb(null, __webpack_require__(261)["default"]);
	      });
	    }
	  }, {
	    path: '/hylist.html',
	    ...
	    getComponent: function getComponent(nextState, cb) {
	      __webpack_require__.e/* nsure */(24, function (require) {
	        cb(null, __webpack_require__(263)["default"]);
	      });
	    }
	  }, {
	    path: '/cklist.html',
	    ...
	    path: '/',
	    getComponent: function getComponent(nextState, cb) {
	      return __webpack_require__.e/* nsure */(32, function (require) {
	    ...
	    indexRoute: {
	      getComponent: function getComponent(nextState, cb) {
	        ...
	        return __webpack_require__.e/* nsure */(32/* duplicate */, function (require) {
	          cb(null, __webpack_require__(271)["default"]);
	        });
	      }
	    }
	...
	_reactDom2["default"].render(_react2["default"].createElement(_reactRouter.Router, { history: _reactRouter.hashHistory, routes: routes }), document.getElementById('wrap'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parsePath = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extractPath = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibActions = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reqwest = __webpack_require__(220);
	...
	var MenuData = [{ tit: "首页", icon: "home", url: "/admin/index", children: [] }, { tit: "内容管理", icon: "xia", children: [{ tit: "栏目管理", url: "/admin/article_type_list" }, { tit: "文章管理", url: "/admin/article_list" }] }, { tit: "退出系统", icon: "sign-in", url: "/admin/logout", children: [] }];
	var newMenuData = [];
	...
	var Sider = function (_Component) {
	  ...
	  function Sider(props) {
	    ...
	    _this.toggleMenu = function (idx) {
	      var setIdx = _this.state.openMenuId;
	      if (setIdx == idx) {
	        setIdx = false;
	      } else {
	        setIdx = idx;
	      }
	      _this.setState({ openMenuId: setIdx });
	    };
	
	    _this.state = {
	      openMenuId: parseInt(_this.props.openMenuId),
	      show: true
	    };
	    return _this;
	  }
	  ...
	  _createClass(Sider, [{
	    ...
	    value: function render() {
	      ...
	      var newArr = menuData.concat(newMenuData);
	
	      return _react2["default"].createElement(
	        'div',
	        { className: 'left-side sticky-left-side', style: { overflow: "hidden", outline: "none" } },
	        _react2["default"].createElement(
	          'div',
	          { className: 'left-side-inner' },
	          _react2["default"].createElement('div', { className: 'sider-top-head' }),
	          _react2["default"].createElement(
	            'ul',
	            { className: 'nav nav-pills nav-stacked custom-nav' },
	            newArr.map(function (obj, idx) {
	              ...
	              if (obj.children.length > 0) {
	                for (var i in obj.children) {
	                  childrenHtml.push(_react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                      'a',
	                      { href: obj.children[i].url ? "#/" + obj.children[i].url : 'javascript:;' },
	                      obj.children[i].name
	                    )
	                  ));
	                }
	              ...
	              return _react2["default"].createElement(
	                'li',
	                { key: idx, className: liClass, onClick: this.toggleMenu.bind(this, idx) },
	                _react2["default"].createElement(
	                  'a',
	                  { href: childrenHtml.length == 0 ? "#" + obj.url : "javascript:;" },
	                  _react2["default"].createElement('i', { className: "iconfont icon-" + obj.icon }),
	                  _react2["default"].createElement(
	                    'span',
	                    null,
	                    obj.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_Component) {
	  ...
	  function Header(props) {
	    ...
	    _this.toggleSider = function () {
	      var onClickToggle = _this.props.onClickToggle;
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          'a',
	          { className: 'toggle-btn', onClick: function onClick() {
	              _this2.toggleSider();
	            } },
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              'a',
	              { href: 'javascript:;', className: 'vm inline-block lh1 mr5' },
	              _react2["default"].createElement('img', { src: userInfo.avatar + '?imageView2/1/w/36/h/36', className: 'br100', alt: '' })
	            ),
	            _react2["default"].createElement(
	              'span',
	              { className: 'fs16' },
	            ...
	            _react2["default"].createElement(
	              'a',
	              { href: 'javascript:;', className: 'fs12 base-color', onClick: this.loginOut },
	              '[\u9000\u51FA]'
	            )
	          )
	        )
...
//# sourceMappingURL=wrap.bundle.js.map