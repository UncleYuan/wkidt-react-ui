          ...
          <div className="Card-box" >
            <Form  formStyle="ver" onSubForm={this.getForm} >
            	<FormCtrl name="username"     required={true} type="text"   placeholder="请在这里输入您的账号" />
      				...
      				<FormCtrl name="test_code"  required={true} type="input-group" placeholder="请在这里输入右边验证码"  barHtml={<img className="code-img vm" onClick={this.resetCodeImgSrc} src={codeImgSrc} />}  ></FormCtrl>
            </Form>
          </div>
        )
    }
