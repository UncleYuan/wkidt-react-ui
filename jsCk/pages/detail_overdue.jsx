            ...
            <div className="wrapper">
                <section  className="p15 white-bg">
                    <div>
                        <div className="">
                          <div className="pb15">
                            <div className="fr btn btn-info fs13" onClick={()=>{ this.toggleModal(1);}}>出入库登记</div>
                            <h4 className="fs20">出入库登记</h4>
                          </div>
                        </div>
                      <div>
                        <Modal title="添加核验档案"   show={modalShow[1]} onClose={()=>{  this.toggleModal(1)}}>
                        ...
                        <div className="table-responsive fixed-loading">
                            <table className="table mt20 table-striped ">
                              ...
                              <tbody>
                                <tr >
                                  <td>2016-10-13 13:23</td>
                                  
                                  <td>287341621</td>
                                  <td>C1234</td>
                                  <td>店库</td>
                                  <td>B2323</td>
                                  <td><FileSingle readOnly={true} title="照片1" value="https://og1r2adir.bkt.clouddn.com/2016-12-06_584673edae58c.jpg?imageView2/1/w/350/h/220" /></td>
                                  <td>尽快回复客户</td>
                                  <td>
                                    <div className=" mb15">
                                      <a href="javascript:;" className="btn btn-sm btn-info" onClick={()=>{ this.toggleModal(1); }}>修改</a>
                                    </div>
                                  </td>
                                </tr>
                              </tbody>
