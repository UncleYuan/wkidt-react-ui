        ...
        fetch('/system/my-menu.do?' + tools.parseParam(parent_id), {
            ...
            .then((data) => {
                fetch('/system/menu.do?' + tools.parseParam({ parent_id: 0 }), {
                    ...
                    this.setState({
                        allParentMenu: res.data,
                        loading: false
                    })
                    let exArr = typeTree(res.data, 0);
                    this.setState({
                        rendData: transform(res.data),
                        exArr: exArr
                    })
                    ...
                    <section className="panel p15">
                        ...
                        <div className="panel-body">
                            <div className="btn-group mb15">
                                ...
                                <a href="javascript:;"  className="btn btn-default" onClick={this.removeItem.bind(this, "all")} type="button">删除所选资源</a>
                            </div>
                            <div id="column-table">
                                <Modal
                                    title="编辑资源"
