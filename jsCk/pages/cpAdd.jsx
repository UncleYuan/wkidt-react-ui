    ...
    getCity = () => {
        tools.getJSONP(`https://api.che300.com/service/getAllCity?token=${carToken}`, (res) => {
            ...
            for (let i in newData) {
                if (newData[i].name == 'reg_time') {
                    newData[i].value = this.props.params.reg_time
                } else if (newData[i].name == 'mileage') {
                    newData[i].value = this.props.params.mileage
                } else if (newData[i].name == 'city_id') {
                    newData[i].options = this.cityOptions
                    newData[i].value = [this.props.params.city_id]
                } else if (newData[i].name == 'level') {
                    newData[i].value = [this.props.params.level]
                } else if (newData[i].name == 'model_id') {
                    newData[i].value = [
                        {
                            name: 'brand_id',
                            value: this.props.params.brand_id
                        },
                        {
                            name:'series_id',
                            value: this.props.params.series_id,
                        },
                        {
                            name:'model_id',
                            value:this.props.params.model_id
                        }
                    ]
