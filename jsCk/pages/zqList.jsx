                    ...
                    <div>
                        <div className="row">
                          <div className=" col-md-9">
                            ...
                            <h4 className="fs20">收息管理列表</h4>
                           <button  className="btn btn-default" onClick={ ()=>{ this.removeItem("all")}} type="button">删除所选资源</button>
                           <a href="javascript:;" className="btn-info btn ml5 mr5">5日内待收息</a>
                           <a href="javascript:;" className="btn-default mr5 btn">10日内待收息</a>
                           <a href="javascript:;" className="btn-default mr5 btn">全部</a>
                            {/*<button  className="btn btn-default" onClick={ ()=>{ this.removeItem("all")}} type="button">删除所选资源</button>*/}
